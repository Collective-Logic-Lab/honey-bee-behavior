#!/usr/bin/env python3
"""Experiment 7: full overlay video for setting 486 with repaired vertical weight 2.0."""
...
DEFAULT_OUT = Path(
    "data/no-sync/exp7_setting486_vert2_overlay_start03/"
    "exp7_setting486_vert2_frames225000_245000.mp4"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Render every frame from 225000 through 245000 with the repaired Experiment 6e "
            "overlay path, using base setting 486 and vertical_feature_weight=2.0."
        )
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=245001,
        help="Exclusive end frame; default includes frame 245000.",
    )
